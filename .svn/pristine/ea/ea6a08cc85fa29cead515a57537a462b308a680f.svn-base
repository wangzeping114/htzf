...
<div class="form-horizontal">
    <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-sm-10">
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="ProductTypeList.aspx">商品类型</a>
                    </li>
                    <li>
                        <strong>商品类型</strong>
                    </li>
            ...
            <div class="col-sm-2 tr">
                <a href="ProductTypeList.aspx" class="btn btn-xs btn-primary">返回列表</a>
            </div>
    ...
    <script>
        ...
        function Open() {
            ...
            syAjaxWithHeader(puMInfo,"Get", false, ConApiUrl + 'manage/cdyprot/getcategoryById/'+mID, "AppManage:123", params, GetInfoBack, syAjaxErrorBack);

        }
        function GetInfoBack(json) {
            if (json && json.Result) {
                mInfo = json.Result;
                $("#txtTypeName").val(mInfo.Name);
                $("#imgMain").val(mInfo.Icon);
                $("#txtSort").val(mInfo.Sequence);
                $("#txtStatus").prop('checked',mInfo.IsDisplay);
            }
        }
        function Save() {
            var params = {
            ...
            if (mID > 0) {
                params.Id = mID;
                syAjaxWithHeader(puMInfo,"POST", false, ConApiUrl + 'manage/cdyprot/updateCategory', "AppManage:123", params, SetTPartnerInfofBack, syAjaxErrorBack);
            } else {
